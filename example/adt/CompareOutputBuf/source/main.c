...
void Adt4UnderFullCalllback(void)
{
    ...
    if (i%2)
    {
        Adt_SetCompareValue(AdTIM4, AdtCompareC, 0x8000);
        Adt_SetCompareValue(AdTIM4, AdtCompareD, 0x4000);
    }
    else
    {
        Adt_SetCompareValue(AdTIM4, AdtCompareC, 0x4000);
        Adt_SetCompareValue(AdTIM4, AdtCompareD, 0x8000);
    }
    i++;
}
